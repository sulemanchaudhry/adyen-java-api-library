...
public class ObjectFactory {
    ...
    private final static QName _CardReaderInitRequestTypeForceEntryMode_QNAME = new QName("", "ForceEntryMode");
    ...
    public JAXBElement<List<String>> createCardReaderInitRequestTypeForceEntryMode(List<String> value) {
        return new JAXBElement<List<String>>(_CardReaderInitRequestTypeForceEntryMode_QNAME, ((Class) List.class), CardReaderInitRequestType.class, ((List<String> ) value));
    }
    ...
    public JAXBElement<List<String>> createTransactionConditionsTypeForceEntryMode(List<String> value) {
        return new JAXBElement<List<String>>(_CardReaderInitRequestTypeForceEntryMode_QNAME, ((Class) List.class), TransactionConditionsType.class, ((List<String> ) value));
    }
    ...
    public JAXBElement<List<String>> createCardAcquisitionTransactionTypeForceEntryMode(List<String> value) {
        return new JAXBElement<List<String>>(_CardReaderInitRequestTypeForceEntryMode_QNAME, ((Class) List.class), CardAcquisitionTransactionType.class, ((List<String> ) value));
    }
